...
rm -f target/linux/generic/pending-5.4/184-USB-serial-option-add-Wistron-Neweb-D19Q1.patch
rm -f target/linux/generic/pending-5.4/403-mtd-hook-mtdsplit-to-Kbuild.patch
rm -f target/linux/generic/hack-5.4/700-swconfig_switch_drivers.patch
